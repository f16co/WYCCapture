...
public:
	...
	bool IsValid();
	static bool IsValid(SYSTEMTIME& time);
	...
	CString ToString(bool millisecond_view = false, bool date = true, bool time = true, DATE_FORMAT date_format = DF_UNKNOWN);
	static CString SysTimeToStr(SYSTEMTIME& sys_time, bool millisecond_view = false, bool date = true, bool time = true, DATE_FORMAT date_format = DF_UNKNOWN);
